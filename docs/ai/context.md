...
- **Test count**: **2274 tests / 8116 assertions** in the default suite (UnitTest + Integration), plus **423 low-value tests** excluded by default; 34 skipped tests document real `src/` bugs (see §23 and `docs/issues/coverage-2026-08-09/`); **never delete or un-skip them** without fixing the underlying bug
