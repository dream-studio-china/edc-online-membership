...
final class LianshengControllerTest extends TestCase
{
    ...
    public function testRejectsCreditDirection(): void
    {
        $service = $this->createMock(LianshengServiceInterface::class);
        ...
        self::assertSame(400, $response->getStatusCode());
        self::assertSame(
            'mobile, dirflag ("-" only; crediting is unsupported), reference, roomtable, and remarks are required.',
            $this->decode($response->getContent())['message'],
        );
    }
    ...
    public static function invalidMemberPointsProvider(): iterable
    {
        ...
        yield 'invalid direction' => [json_encode(['mobile' => '13802542123', 'dirflag' => 'x', 'points' => 10, 'reference' => 'REF', 'roomtable' => 'ONLINE', 'remarks' => 'Manual adjustment'], JSON_THROW_ON_ERROR), 'mobile, dirflag ("-" only; crediting is unsupported), reference, roomtable, and remarks are required.'];
        yield 'credit direction' => [json_encode(['mobile' => '13802542123', 'dirflag' => '+', 'points' => 10, 'reference' => 'REF', 'roomtable' => 'ONLINE', 'remarks' => 'Manual adjustment'], JSON_THROW_ON_ERROR), 'mobile, dirflag ("-" only; crediting is unsupported), reference, roomtable, and remarks are required.'];
        yield 'invalid field type' => [json_encode(['mobile' => [], 'dirflag' => '-', 'points' => 10, 'reference' => 'REF', 'roomtable' => 'ONLINE', 'remarks' => 'Manual adjustment'], JSON_THROW_ON_ERROR), 'mobile, dirflag ("-" only; crediting is unsupported), reference, roomtable, and remarks are required.'];
        ...
        yield 'invalid account date' => [json_encode(['mobile' => '13802542123', 'dirflag' => '-', 'points' => 10, 'reference' => 'REF', 'roomtable' => 'ONLINE', 'remarks' => 'Manual adjustment', 'accountDate' => '2026-02-30'], JSON_THROW_ON_ERROR), 'accountDate must use YYYY-MM-DD.'];
    }
